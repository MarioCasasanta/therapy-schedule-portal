    ...
    <footer className="bg-sage-900 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <Link to="/" className="flex items-center text-2xl font-playfair font-semibold mb-4">
              <Heart className="h-6 w-6 text-pink-500 mr-2 fill-pink-500" />
              <span className="text-white">Além do Apego</span>
            </Link>
            <p className="text-sage-300 text-sm">
              Apoio psicológico para mulheres com dificuldades na separação do ex-parceiro.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/" className="text-sage-300 hover:text-white">Início</Link></li>
        ...
        <div className="border-t border-sage-800 mt-8 pt-8 text-center text-sage-400 text-sm">
          <p>&copy; {new Date().getFullYear()} Além do Apego. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  );
