...
const SubscriptionPlanCard: React.FC<SubscriptionPlanCardProps> = ({
  ...
  return (
    <Card className={`relative ${isHighlighted ? 'shadow-lg ring-2 ring-primary/20' : 'shadow'}`}>
      {isHighlighted && (
      ...
      <CardFooter>
        <Button 
          ...
          className={`w-full ${isHighlighted ? 'bg-primary hover:bg-primary/90' : 'bg-primary hover:bg-primary/90'}`}
        >
          {buttonText}
        </Button>
      </CardFooter>
